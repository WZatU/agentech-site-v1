...
const naviFunctionDefinitions: AgentechFunction[] = [
  ...
  namedExtendedAction("prepare_camera", "Navi moves into the firmware camera-preparation pose."),
  ...
  namedExtendedAction("camera_stand_3s", "Navi holds the camera standing pose for three seconds."),
  namedExtendedAction("take_photo", "Navi performs the take-photo pose sequence."),
  namedExtendedAction("photo_wave_hand", "Navi waves a front paw for the camera."),
  namedExtendedAction("brush_teeth_vertical_30s", "Navi runs the 30-second vertical tooth-brushing routine."),
  namedExtendedAction("before_take_photo_fast", "Navi quickly moves into the pre-photo pose."),
  namedExtendedAction("after_take_photo_1_fast", "Navi performs the first quick post-photo pose."),
  namedExtendedAction("after_take_photo_2_fast", "Navi performs the second quick post-photo pose."),
