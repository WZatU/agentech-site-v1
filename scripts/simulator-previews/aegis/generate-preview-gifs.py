...
SIMULATOR_ROOT = ROOT / "simulators" / "aegis"
OUT_DIR = ROOT / "public" / "assets" / "products" / "agentech-library" / "simulator-previews" / "aegis"

sys.path.insert(0, str(SIMULATOR_ROOT))

from aegis_runtime import mujoco_sim as sim  # noqa: E402
from aegis_runtime.mujoco_sim import MuJoCoCommand, MuJoCoPreview  # noqa: E402
