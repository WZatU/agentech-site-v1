...
- Website asset:
  `public/assets/products/agentech-library/navi-simulations/stand/navi-stand-up.mp4`

Regenerate from the extracted Navi MuJoCo model package:

```powershell
python scripts/navi-simulations/stand/render_navi_stand_preview.py `
  --model-root C:\path\to\Navi_MuJoCo `
  --output public/assets/products/agentech-library/navi-simulations/stand/navi-stand-up.mp4
```
