...
const softwareSecurityReviewPrompt = [
  ...
  "- Public Agentech L0.5 robot API calls: forward, backward, lateral, turn, yaw, pitch, roll, stay, return_to_neutral, backflip, jump, stand, sit, stop, emergency_stop, look, and get_battery_status.",
  ...
  "- Calls such as Agentech.forward(speed_percent=40, duration_s=1.0), Agentech.lateral(direction='left', speed_mps=0.2), Agentech.turn(angle_deg=45, turn_rate_deg_s=22.5), and Agentech.look(direction='down', look_level=3).",
