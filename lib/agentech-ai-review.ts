...
const softwareSecurityReviewPrompt = [
  ...
  "- Public Agentech L0.5 robot API calls: forward, backward, lateral, turn, yaw, pitch, roll, stay, backflip, jump, stand, squat, sit, stop, emergency_stop, and get_battery_status.",
  ...
  "- Calls such as Agentech.forward(speed_percent=40, duration_s=1.0), Agentech.lateral_left(speed_mps=0.5, duration_s=2.0), Agentech.diagonal(x_m=0.5, y_m=1.0, duration_s=2.0), Agentech.turn(angle_deg=45, turn_rate_deg_s=22.5), Agentech.sit(), Agentech.stop(), Agentech.emergency_stop(), and Agentech.get_battery_status().",
