...
const softwareSecurityReviewPrompt = [
  ...
  "- Public Agentech L0.5 robot API calls: forward, backward, lateral, diagonal, turn, yaw, pitch, roll, stay, backflip, jump, stand, squat, squat_forward, squat_backward, squat_lateral, squat_diagonal, squat_turn, sit, stop, emergency_stop, battery, get_body_state, imu, and capture_image.",
