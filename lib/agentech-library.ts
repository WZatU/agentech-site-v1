...
export const agentechFunctions: AgentechFunction[] = [
  {
    ...
    params: [
      ...
      p("pace", "enum {slow, normal, fast}", "Named pace profiles are still being designed and physically validated.", undefined, "development"), p("distance_m", "float (0, 5]", "Open-loop estimate only. The SDK derives a timed velocity from distance and duration; acceleration, gait transitions, foot slip, terrain, and stopping latency can change the actual distance."),
