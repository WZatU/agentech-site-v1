...
export const agentechSdkSpec: Record<string, Spec> = {
  ...
  twist: { allowed: ["direction", "angle_deg", "yaw_rate_rad_s", "angle_percent", "twist_level", "hold_s"], required: ["direction"], selectors: ["angle_deg", "angle_percent", "twist_level"], rules: { direction: pick("left", "right"), angle_deg: num(0, 30, true), yaw_rate_rad_s: num(0.05, 0.5), angle_percent: integer(1, 100), twist_level: level, hold_s: num(0, 3) } },
